...
ifeq ($(AB_OTA_UPDATER),true)
	...
	DISK_VDA_PARTITION_VBMETA_A_START_SECTOR := 26529792
	DISK_VDA_PARTITION_VBMETA_B_START_SECTOR := 26531840
	DISK_VDA_PARTITION_VBMETA_SYSTEM_A_START_SECTOR := 26533888
	DISK_VDA_PARTITION_VBMETA_SYSTEM_B_START_SECTOR := 26535936
	DISK_VDA_PARTITION_VBMETA_VENDOR_A_START_SECTOR := 26537984
	DISK_VDA_PARTITION_VBMETA_VENDOR_B_START_SECTOR := 26540032
	...
	DISK_VDA_PARTITION_VBMETA_A_SECTORS := 2048
	DISK_VDA_PARTITION_VBMETA_B_SECTORS := 2048
	DISK_VDA_PARTITION_VBMETA_SYSTEM_A_SECTORS := 2048
	DISK_VDA_PARTITION_VBMETA_SYSTEM_B_SECTORS := 2048
	DISK_VDA_PARTITION_VBMETA_VENDOR_A_SECTORS := 2048
	DISK_VDA_PARTITION_VBMETA_VENDOR_B_SECTORS := 2048
	...
	ifeq ($(BOARD_SUPER_PARTITION_SIZE),3221225472)
		...
		DISK_VDA_PARTITION_VBMETA_START_SECTOR := 7544832
		DISK_VDA_PARTITION_VBMETA_SYSTEM_START_SECTOR := 7546880
		DISK_VDA_PARTITION_VBMETA_VENDOR_START_SECTOR := 7548928
		...
		DISK_VDA_PARTITION_FIRMWARE_SECTORS := 262144
		DISK_VDA_PARTITION_PERSIST_SECTORS := 32768
		DISK_VDA_PARTITION_VBMETA_SECTORS := 2048
		DISK_VDA_PARTITION_VBMETA_SYSTEM_SECTORS := 2048
		DISK_VDA_PARTITION_VBMETA_VENDOR_SECTORS := 2048
		...
		DISK_VDA_PARTITION_VBMETA_START_SECTOR := 9654016
		DISK_VDA_PARTITION_VBMETA_SYSTEM_START_SECTOR := 9656064
		DISK_VDA_PARTITION_VBMETA_VENDOR_START_SECTOR := 9658112
		DISK_VDA_PARTITION_EFI_SECTORS := 524288
