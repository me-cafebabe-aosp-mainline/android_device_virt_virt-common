...
$(INSTALLED_ISOIMAGE_INSTALL_TARGET): $(INSTALLED_ESPIMAGE_INSTALL_TARGET)
	...
	$(BOOTMGR_PATH_OVERRIDE) $(GRUB_PREBUILT_DIR)/bin/grub-mkrescue -d $(GRUB_PREBUILT_DIR)/lib/grub/$(TARGET_GRUB_ARCH) --xorriso=/usr/bin/xorriso -o $@ $(INSTALLED_ESPIMAGE_INSTALL_TARGET_DEPS) $(GRUB_WORKDIR_INSTALL)/fsroot
